...
// Refined Abstraction with extra functionality
...
const editorHtml = new Editor(new HtmlPainter(content));
//const editor = new Editor(new CanvasPainter(canvas));
//const editor = new EditorWithClear(new HtmlPainter(content));
const editorCanvasWithClear = new EditorWithClear(new CanvasPainter(canvas));
...
range.addEventListener("input", (e) => {
  ...
  editorCanvasWithClear.print(width, height, color);
});
